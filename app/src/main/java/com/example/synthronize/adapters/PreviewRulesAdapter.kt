...
//for viewing rules in community preview
class PreviewRulesAdapter(private val rules: HashMap<String, String>):
    RecyclerView.Adapter<PreviewRulesAdapter.RuleViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PreviewRulesAdapter.RuleViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding = ItemRuleBinding.inflate(inflater, parent, false)
        return RuleViewHolder(binding)
    }

    override fun onBindViewHolder(holder: PreviewRulesAdapter.RuleViewHolder, position: Int) {
